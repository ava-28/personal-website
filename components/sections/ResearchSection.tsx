...
export function ResearchSection() {
  return (
    <section id="research" className="scroll-mt-24 border-t border-stone-300 pt-20 dark:border-slate-800 xl:scroll-mt-10">
                ...
                <div className="overflow-hidden rounded-2xl border border-stone-200 bg-white/60 transition-all hover:border-accent-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800/60 dark:hover:border-accent-600">
                  ...
                  <div className="p-6">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <div>
                        <h3 className="font-sans text-base font-bold text-stone-900 transition-colors group-hover:text-accent-600 dark:text-slate-100 dark:group-hover:text-accent-400">
                          {area.title}
                        </h3>
